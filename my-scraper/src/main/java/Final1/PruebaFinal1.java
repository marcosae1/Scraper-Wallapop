        ...
        metodo.productoFecha(ruta, tipoDeProducto);
         ...
         try {              
	           ...
	           System.out.println("Estos son los productos añadidos: ");
	            ...
	            //Bucle para cada elemento de la lista etiquetasA
	            ...
	            for (int i=0; i<etiquetasA.size(); i++) {
	            	...
	            	Solo los productos llevan en su información el símbolo "€" (en el precio, incluído en elemento.getText()), por lo que es buena forma de discriminar*/
